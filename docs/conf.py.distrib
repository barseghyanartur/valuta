# -*- coding: utf-8 -*-
#
# valuta documentation build configuration file.
#
...
try:
    ...
    version = '0.1'
    project = 'valuta'
    copyright = '2021, Artur Barseghyan <artur.barseghyan@gmail.com>'
